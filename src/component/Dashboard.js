...
function Dashboard() {
  ...
  const fetchFlashcards = () => {
    axios
      .get("https://flashcard-6yof.onrender.com/flashcards")
  ...
  const handleAddFlashcard = () => {
    axios
      .post("https://flashcard-6yof.onrender.com/flashcards", newCard)
      .then(() => {
        fetchFlashcards();
  ...
  const handleUpdateFlashcard = () => {
    if (editingCard) {
      axios
        .put(
          `https://flashcard-6yof.onrender.com/flashcards/${editingCard.id}`,
          editingCard
        )
        .then(() => {
          fetchFlashcards();
  ...
  const handleDeleteFlashcard = (id) => {
    if (window.confirm("Are you sure you want to delete this flashcard?")) {
      axios
        .delete(`https://flashcard-6yof.onrender.com/flashcards/${id}`)
        .then(() => {
          fetchFlashcards();
